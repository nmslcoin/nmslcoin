...
#### NMSLCoin is a fun, fast, and easy way to send money to friends and businesses
<!--
...
-->
### Contributing to NMSLCoin

We are a community of people across the world giving our time to make this software better. There are many ways you can help or join us:

-   If you'd like to report a bug, [fill out a bug report](https://github.com/nmslecoin/nmslcoin/issues/new?template=bug_report.md)
-   If you'd like to submit code for a bug you fixed, [submit a pull-request](https://github.com/nmslcoin/nmslcoin/compare)
-   If you're a tester submitting tests you've done on a Release Candidate, [click here](https://github.com/nmslcoin/nmslcoin/issues/new?template=release-candidate.md)
-   If you're a beginner developer, and want a list of easy things you can accomplish to help, [click here for a list of TODOs](https://github.com/nmslcoin/nmslcoin/labels/GOOD%20FIRST%20ISSUE)
...
To use NMSLCoin, you'll need a way to connect to the network, and a wallet to hold your funds. This software includes those things for you, you can compile it yourself, or you can download the ones that we have compiled for you.

**Click here to download: http://nmslcoin.github.io**

To compile from sourcecode yourself, [click here for build instructions](https://github.com/nmslcoin/nmslcoin/blob/development/COMPILE.md).
...
-   **Use checkpoints** - Checkpoints help your node sync faster, [learn more](http://nmslcoin.github.io/use.html)
-   **Learn things** - Syncing will take time, to help pass that time [learning how to use SM](https://nmslcoin.github.io/docs/)
-   **Backup your keys** - You can generate a wallet right inside the software, or use [this generator](https://nmslcoin.github.io/wallet/) that will make a [printable physical paper wallet](https://nmslcoin.github.io/docs/guides/wallets/making-a-wallet) to put in a safe place for later.
...
See [src/config/CryptoNoteConfig.h](https://github.com/nmslcoin/nmslcoin/commit/28cfef2575f2d767f6e512f2a4017adbf44e610e) for an example.
